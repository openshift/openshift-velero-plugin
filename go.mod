...
require (
	...
	github.com/migtools/udistribution v0.0.12-oadp-1.2
	...
	github.com/vmware-tanzu/velero v1.9.5
	k8s.io/api v0.26.3
...
// sha from go get github.com/openshift/velero@oadp-1.1
replace github.com/vmware-tanzu/velero => github.com/openshift/velero v0.10.2-0.20230316211407-ffb10f9aa8a8

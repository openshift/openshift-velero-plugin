...
func (p *BackupPlugin) Execute(item runtime.Unstructured, backup *v1.Backup) (runtime.Unstructured, []velero.ResourceIdentifier, error) {
	...
	pv, err := client.PersistentVolumes().Get(context.TODO(), backupPV.Name, metav1.GetOptions{})
	if err != nil {
		return nil, nil, err
	}
	...
	pv, err = client.PersistentVolumes().Update(context.TODO(), pv, metav1.UpdateOptions{})
	if err != nil {
		return nil, nil, err
	}
